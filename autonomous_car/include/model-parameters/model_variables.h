...
const char* ei_classifier_inferencing_categories[] = { "Parada Obrigatoria sign", "Vire a esquerda sign" };
...
const ei_impulse_t impulse_575563_0 = {
    .project_id = 575563,
    .project_owner = "Rafael",
    .project_name = "TCC-pare-direita-esquerda-cam-raspberry",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 18,

    .nn_input_frame_size = 38416,
    .raw_sample_count = 38416,
    .raw_samples_per_frame = 1,
    .dsp_input_frame_size = 38416 * 1,
    .input_width = 196,
    .input_height = 196,
    .input_frames = 1,
    .interval_ms = 1,
    ...
    .visual_ad_grid_size_x = int((196 / 8) / 2 - 1),
    .visual_ad_grid_size_y = int((196 / 8) / 2 - 1),
    
    .tflite_output_features_count = 1875,
...
ei_impulse_handle_t impulse_handle_575563_0 = ei_impulse_handle_t( &impulse_575563_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_575563_0;
